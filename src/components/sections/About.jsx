...
const About = () => {
    return (
        <section id="about" className="relative flex flex-col items-center justify-center h-full p-4 text-center text-white bg-gradient-to-b from-gray-900 to-gray-800">

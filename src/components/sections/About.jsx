...
const About = () => {
    return (
        <section id="about" className="relative flex flex-col items-center justify-center h-screen p-4 text-center text-white bg-gradient-to-b from-gray-900 to-gray-800">
            ...
            <div className="flex flex-col items-center max-w-3xl gap-6 mx-auto animate-fade-in">
                ...
                <p className="text-lg leading-relaxed text-gray-300 duration-500 sm:text-xl animate-fade-in">
                ...
                <a target="_blank" href={Dummy} download="Dummy.pdf"
                    className='px-6 py-3 text-lg font-semibold text-white transition-transform duration-500 transform rounded-lg shadow-xl w-fit bg-gradient-to-r from-blue-500 to-purple-500 hover:scale-105 hover:shadow-2xl animate-fade-in'>
                    📄 View Resume
                </a>
            </div>
        </section>

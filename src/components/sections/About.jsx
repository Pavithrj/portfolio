...
const About = () => {
    return (
        <section id="about" className="relative flex flex-col items-center justify-center h-full min-h-screen p-4 text-center text-white lg:px-0 bg-gradient-to-b from-gray-900 to-gray-800">

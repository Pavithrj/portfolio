...
const Skills = () => {
    ...
    return (
        <section id="skills" className="relative flex flex-col items-center justify-center h-full min-h-screen p-4 text-center text-white xl:p-0 bg-gradient-to-b from-gray-900 to-gray-800">
